...
/**
 * The object used to query meta data for weather stations which provide climatic data to the system.  Weather station meta data
 * comes directly from the ACIS interface.
 * 
 * @author Ian Cottingham
 */
@Remote
public interface ClimateMetaDataQuery {
