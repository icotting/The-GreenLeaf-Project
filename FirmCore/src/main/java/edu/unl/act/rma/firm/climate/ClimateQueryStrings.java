...
/**
 * A set of query strings used by the climate data objects.  This enumeration allows the data queries to be managed outside
 * of the implementing logic, resulting in less obfuscated management of queries.
 * 
 * @author Ian Cottingham
 */ 
public enum ClimateQueryStrings {
...
//	updated AVERAGE_ANNUAL_BASE query  jira FARM-445
	...
	private ClimateQueryStrings(String str) { 
		queryString = str;
	}
